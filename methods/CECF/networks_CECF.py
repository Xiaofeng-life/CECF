...
class AdaINGen_a(nn.Module):
    ...
    def __init__(self, input_dim, params, use_trans_block):
        ...
        # add new fix color encoder and decoder
        self.enc_fix_color = StyleEncoder(4, input_dim, dim, style_dim, norm='none', activ=activ, pad_type=pad_type)
    ...
    def forward(self, images):
        ...
        # add new encode
        content, style_fake, fix_color_code = self.encode(images)
        images_recon = self.decode(content, style_fake)

        # add fix enhanced result
        fix_enhanced = self.dec_fix(content, fix_color_code)
        return images_recon, fix_enhanced
    ...
    def encode(self, images):
        ...
        # add new encode
        fix_color_code = self.enc_fix_color(images)
        return content, style_fake, fix_color_code

    def decode_fix(self, content, fix_color_code):
        # decode content and style codes to an image
        adain_params = self.mlp_fix(fix_color_code)
